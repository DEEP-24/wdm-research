...
export default function AuthLayout({
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="w-full lg:w-3/5 flex items-center justify-center bg-gradient-to-br from-blue-100 via-blue-50 to-indigo-100">
        <div className="w-full max-w-2xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-16">
          {children}
        </div>
      </div>
